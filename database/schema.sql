...
-- Toloni Pescarias Database Schema
...
('Administrador', 'admin@tolonipescarias.com', '$2y$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqyT4XyrrLg5vLyZB77SRG6', 1),
('João Pescador', 'joao@exemplo.com', '$2y$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqyT4XyrrLg5vLyZB77SRG6', 0);

-- Localidades de exemplo
INSERT INTO locations (name, description, image_url, city, state, whatsapp, featured, fish_species, facilities) VALUES 
(
    'Rio Amazonas - Manaus',
    'Uma das experiências de pesca mais incríveis do Brasil. O Rio Amazonas oferece uma diversidade única de peixes e paisagens deslumbrantes.',
    'https://images.unsplash.com/photo-1441260038675-7329ab4cc264?w=800',
    'Manaus',
    'Amazonas',
    '5592999887766',
    1,
    '["Tucunaré", "Piranha", "Pirarucu", "Surubim", "Tambaqui"]',
    '["Guia especializado", "Equipamentos inclusos", "Almoço", "Transporte"]'
),
(
    'Pantanal - Dourado',
    'O Pantanal é o paraíso dos pescadores esportivos. Águas cristalinas e uma fauna rica proporcionam experiências inesquecíveis.',
    'https://images.unsplash.com/photo-1482938289607-e9573fc25ebb?w=800',
    'Corumbá',
    'Mato Grosso do Sul',
    '5567988776655',
    1,
    '["Dourado", "Pintado", "Pacu", "Piavuçu", "Jaú"]',
    '["Pousada completa", "Barco com motor", "Guia profissional", "Todas as refeições"]'
),
(
    'Represas de Furnas',
    'Excelente local para pesca de tucunarés e outras espécies. Águas calmas e estrutura completa para pescadores.',
    'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=800',
    'São José da Barra',
    'Minas Gerais',
    '5535987654321',
    1,
    '["Tucunaré", "Black Bass", "Lambari", "Traíra", "Mandi"]',
    '["Rampa para barcos", "Lanchonete", "Banheiros", "Estacionamento"]'
);

-- Relatos de exemplo
INSERT INTO reports (title, content, location_id, user_id, images, fish_species, weather_conditions, featured, fishing_date) VALUES 
(
    'Incrível pescaria de tucunarés no Amazonas',
    'Que experiência fantástica! Conseguimos pescar diversos tucunarés de bom tamanho. O guia conhecia os melhores pontos e a paisagem é de tirar o fôlego. Recomendo muito esta aventura!',
    1,
    2,
    '["https://images.unsplash.com/photo-1482938289607-e9573fc25ebb?w=400", "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400"]',
    'Tucunaré',
    'Sol e temperatura agradável',
    1,
    '2024-01-15'
),
(
    'Dourados gigantes no Pantanal',
    'Uma semana inesquecível no Pantanal. Conseguimos pescar dourados de mais de 10kg! A estrutura da pousada é excelente e a comida maravilhosa.',
    2,
    2,
    '["https://images.unsplash.com/photo-1545450660-ec47c0326fbc?w=400"]',
    'Dourado',
...
(1, 1, 'Que relato incrível! Estou planejando uma viagem para o Amazonas também.'),
(2, 1, 'Pantanal é realmente um paraíso para pescadores!');

-- Mídia para carrossel
INSERT INTO admin_media (type, url, title, alt_text, display_order, active) VALUES 
('image', 'https://images.unsplash.com/photo-1441260038675-7329ab4cc264?w=1600', 'Pesca no Rio Amazonas', 'Pescador no Rio Amazonas', 1, 1),
('image', 'https://images.unsplash.com/photo-1482938289607-e9573fc25ebb?w=1600', 'Pantanal - Paraíso da Pesca', 'Paisagem do Pantanal', 2, 1),
('image', 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=1600', 'Equipamentos Profissionais', 'Equipamentos de pesca', 3, 1);
...
-- Criar usuário MySQL para a aplicação (execute separadamente se necessário)
-- CREATE USER 'toloni_user'@'localhost' IDENTIFIED BY 'senha_forte_aqui';
-- GRANT SELECT, INSERT, UPDATE, DELETE ON toloni_pescarias.* TO 'toloni_user'@'localhost';
-- FLUSH PRIVILEGES;

-- Limpar sessões expiradas (procedure para manutenção)
DELIMITER //
...
-- ===============================================
-- ADICIONAIS DE SEGURANÇA CRÍTICOS - 8 SISTEMAS
-- ===============================================

-- 1. Tabela para Autenticação 2FA
...
-- 2. Tabela para Criptografia de Dados
...
-- 3. Tabela para Sistema Honeypot
...
-- 4. Tabela para Whitelist de IPs Admin
...
-- 5. Tabela para Backup Automático
...
-- 6. Tabela para Monitoramento de Integridade
...
-- 7. Tabela para WAF (Web Application Firewall)
...
-- 8. Tabela para Auditoria e Compliance LGPD
...
-- Inserir configurações de segurança no sistema
INSERT INTO system_settings (setting_key, setting_value, setting_type, description) VALUES 
...
-- Comentários sobre índices para performance
-- Os índices criados otimizam:
-- - Busca por email de usuários
-- - Listagem de conteúdo aprovado e ativo
